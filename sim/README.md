...
only top-level ports; DEBUG adds the signals in a Verilator control file and
an FST; INSPECT adds the same selected VPI visibility without a waveform; the
